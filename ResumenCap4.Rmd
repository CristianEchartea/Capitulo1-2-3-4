...
Uno de los grandes ayudas de aprender R es construir varios ejemplos de datos.
internet representa un incremento importante de fuentes para datasets largos, y ofrecen una corta pero util introduccion, a algunas maneras de como podemos obtener en internet los datos, en internet y meterlos a una sesion de R.
...
Internet es una fuente cada vez más importante de grandes volúmenes de datos. Proporciona enlaces a archivos que contienen los datos que queremos, lo que nos permite obtener datos siguiendo los tres pasos:
...
para cada elemento de autoMpgRecords regresando los vectores de noQuotes.
Una vez aplicado esto al vector nosotros aplicamos los siguientes pasos por cada elemento
